  ...
  return (
    <div className="relative bg-[#F7F8FA] p-4 rounded-xl w-fit transition duration-300">
      <ShoppingCart
        ...
        strokeWidth={2}
      />
      <span className="absolute -top-1 -right-1 flex items-center justify-center w-6 h-6 bg-hover text-white text-xs font-bold rounded-full leading-none text-center">
        3
      </span>
    </div>
  );
